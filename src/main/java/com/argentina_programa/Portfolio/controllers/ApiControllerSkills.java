...
public class ApiControllerSkills {
    ...
    public ResponseEntity <Object> save (@RequestBody Skills estudio, @RequestHeader("Authorization") String token) throws ApiUnauthorizazed{
        try{ 
    ...
    public ResponseEntity <Object> update ( @RequestBody Skills exp,@PathVariable int id,@RequestHeader("Authorization") String token) throws ApiUnauthorizazed{
         try{ 
        boolean bandera = getAuthentication(token);
        if(bandera)
